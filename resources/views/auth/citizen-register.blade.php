...
@section('title', 'Inscription - Espace Citoyen')
            ...
            <div class="card shadow">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        ...
                        <h3 class="mt-3">Créer votre compte citoyen</h3>
                        <p class="text-muted">Rejoignez IdentiGuinée dès aujourd'hui</p>
                    </div>
                    ...
                    <form action="{{ route('citizen.register') }}" method="POST">
                        @csrf
                        <div class="row">
